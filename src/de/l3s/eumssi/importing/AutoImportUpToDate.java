/**
 * This module import data up to date automatically
 * --served for wikitimesicrawl collaboration
 */
...
public class AutoImportUpToDate {
	...
	public static void main(String[] args) {
		...
		AutoImportUpToDate importer = new AutoImportUpToDate();
		String command = args[0]; 
		
		if(args.length == 1){
			if(command.equals("redirections")){
