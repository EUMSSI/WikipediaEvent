...
/**
 * This file is used to extract the wikinews from March 2006 to April 2006. These two have weird date structure so we need a separate file for that.
 * @author kanik
 */
public class Wiki5 {
    public static void main(String[] args) {
    	Wiki5 importer = new Wiki5();
    	importer.run();
    }
    ...
    public void run() {
        ...
        for(int i=3;i<=4;i++){
            ...
            String url = "http://en.wikipedia.org/wiki/"+returnMonth(i)+"_2006";
